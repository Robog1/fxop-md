...
Module(
 ...
 async (message, match) => {
  ...
  const data = await getJson(`http://api.openweathermap.org/database/2.5/weather?q=${match}&units=metric&appid=060a6bcfa19809c2cd4d97a212b19273&language=en`).catch(() => {});
